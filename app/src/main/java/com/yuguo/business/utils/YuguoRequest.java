...
public class YuguoRequest<T> extends Request<T>{
     ...
     * @param listener
     */
    public YuguoRequest(String url, Type type, Map<String, String> params,ResponeListener<T> listener) {
     ...
     * @param listener
     */
    public YuguoRequest(int method, String url, Type type,Map<String, String> params, ResponeListener<T> listener) {
    ...
    public static Map<String, String> setCommonArgs(Map<String, String> params) {
        ...
        if(params!=null){
        	...
        	params.put("yuguo_date_669", dateStr);
        	params.put("yuguo_token_669", RSA.sign(dateStr + "ygAPP", ConstantUtils.RSA_PRIVATE, "utf-8"));
        }else{
